    ...
    if 'user' in session and session['rol'] == "Superadministrador":
        ...
        if request.method == 'POST':
            ...
            if 'search_bar' in a.keys():
                ...
                resultados = searchAPI.busqueda(busqueda)
                correo = session.get('user')        
                usuario = dbUsuarios.consultarUsuarios(correo)               
                username = nombreAPI.username(usuario[0][1], usuario[0][2])

                if len(resultados) == 0 or resultados == None:
                    busqueda_mensaje = "No se encontro el plato."
                    plato_informacion = []                   
                    return render_template("search_sadmin.html", productos_jinja=plato_informacion, heading=busqueda_mensaje, username=username)
                else:
                    plato_informacion = db.consultarProductosNombre(resultados[0])
                    return render_template("search_sadmin.html", productos_jinja=plato_informacion, heading="Estos son los resultados cercanos a la búsqueda realizada", username=username)
            ...
            if 'add_pName' in a.keys():
                ...
                if isinstance(comparar_pID, bool) == True:
                    ...
                    if isinstance(tabla, bool) == False: #Tabla llena
                        return render_template("products_sadmin.html", variable_jinja=tabla, username=username)
                    elif tabla == False: #Valida si la tabla esta vacia
                        return render_template("products_sadmin.html", username=username)
                    ...
                    if isinstance(tabla, bool) == False: #Tabla llena
                        return render_template("products_sadmin.html", variable_jinja=tabla, error_add_pName="Un producto de nombre similar ya se encuentra registrado.", username=username)
                    elif tabla == False: #Valida si la tabla esta vacia
                        return render_template("products_sadmin.html", username=username)              
                ...
                if resultado == False: #No encontro nada
                    ...
                    if isinstance(tabla, bool) == False:
                        return render_template("products_sadmin.html", error_search_pID="No se encontro la ID.", variable_jinja=tabla, username=username)
                    elif tabla == False:
                        return render_template("products_sadmin.html", error_search_pID="No hay productos para buscar.", username=username)
                else:
                    print("Encontro la ID")
                    tabla = db.consultarTodosProductos()      
                    return render_template("products_sadmin.html", upgrade_pID=resultado[0][0], upgrade_pName=resultado[0][1], upgrade_pPrice=resultado[0][2], upgrade_pAmount=resultado[0][3], upgrade_pDescription=resultado[0][4], variable_jinja=tabla, username=username)
                ...
                return render_template("products_sadmin.html", variable_jinja=tabla, Confirmation="Producto actualizado.", username=username)
                ...
                if resultado == True: #Codear logica para borrar comentarios y comentarios
                    tabla = db.consultarTodosProductos()
                    if isinstance(tabla, bool) == False:                    
                        return render_template("products_sadmin.html", variable_jinja=tabla, confirmation_delete="Producto eliminado.", username=username)
                    elif tabla == False:
                        return render_template("products_sadmin.html", confirmation_delete="Producto eliminado.", username=username)                  
                    ...
                    resultados = dbUsuarios.consultarUsuarios(correo)
                    if isinstance(tabla, bool) == False:
                        return render_template("products_sadmin.html", variable_jinja=tabla, error_delete_pID="Producto no existente.", username=username)
                    elif tabla == False:
                        return render_template("products_sadmin.html", error_delete_pID="No hay productos para Eliminar.", username=username)
            ...
            if isinstance(tabla, bool) == False:
                return render_template("products_sadmin.html", variable_jinja=tabla, error_add_pName="", username=username)
            elif tabla == False:
                return render_template("products_sadmin.html", error_add_pName="", username=username)
    
    elif 'user' in session and session['rol'] == "Administrador":
        print("ENTRO A RUTA COMO ADMIn")
        if request.method == 'POST':
            print("RECIBIO POST")
            ...
            if 'search_bar' in a.keys():
                ...
                if len(resultados) == 0 or resultados == None:
                    busqueda_mensaje = "No se encontro el plato."
                    plato_informacion = []                   
                    return render_template("search_admin.html", productos_jinja=plato_informacion, heading=busqueda_mensaje, username=username)
                else:
                    plato_informacion = db.consultarProductosNombre(resultados[0])
                    # Estos son los resultados cercanos a la búsqueda realizada
                    #Renderizar search del respectivo usuario
                    #Cargar Jinja
                    return render_template("search_admin.html", productos_jinja=plato_informacion, heading="Estos son los resultados cercanos a la búsqueda realizada", username=username)
            ...
            if 'add_pName' in a.keys():
                ...
                if isinstance(comparar_pID, bool) == True:
                    ...
                    if isinstance(tabla, bool) == False: #Tabla llena
                        return render_template("products_admin.html", variable_jinja=tabla, username=username)
                    elif tabla == False: #Valida si la tabla esta vacia
                        return render_template("products_admin.html", username=username)
                    ...
                    if isinstance(tabla, bool) == False: #Tabla llena
                        return render_template("products_admin.html", variable_jinja=tabla, error_add_pName="Un producto de nombre similar ya se encuentra registrado.", username=username)
                    elif tabla == False: #Valida si la tabla esta vacia
                        return render_template("products_admin.html", username=username)            
                ...
                if resultado == False: #No encontro nada
                    ...
                    tabla = db.consultarTodosProductos()
                    if isinstance(tabla, bool) == False:
                        return render_template("products_admin.html", error_search_pID="No se encontro la ID.", variable_jinja=tabla, username=username)
                    elif tabla == False:
                        return render_template("products_admin.html", error_search_pID="No hay productos para buscar.", username=username)
                else:
                    print("Encontro la ID")
                    tabla = db.consultarTodosProductos()        
                    return render_template("products_admin.html", upgrade_pID=resultado[0][0], upgrade_pName=resultado[0][1], upgrade_pPrice=resultado[0][2], upgrade_pAmount=resultado[0][3], upgrade_pDescription=resultado[0][4], variable_jinja=tabla, username=username)
                ...
                return render_template("products_admin.html", variable_jinja=tabla, Confirmation="Producto actualizado.", username=username)
                ...
                if resultado == True: #Codear logica para borrar comentarios y comentarios
                    tabla = db.consultarTodosProductos()
                    if isinstance(tabla, bool) == False:                    
                        return render_template("products_admin.html", variable_jinja=tabla, confirmation_delete="Producto eliminado.", username=username)
                    elif tabla == False:
                        return render_template("products_admin.html", confirmation_delete="Producto eliminado.", username=username)                  
                    ...
                    tabla = db.consultarTodosProductos()
                    if isinstance(tabla, bool) == False:
                        return render_template("products_admin.html", variable_jinja=tabla, error_delete_pID="Producto no existente.", username=username)
                    elif tabla == False:
                        return render_template("products_admin.html", error_delete_pID="No hay productos para Eliminar.", username=username)
            ...
            if isinstance(tabla, bool) == False:
                return render_template("products_admin.html", variable_jinja=tabla, error_add_pName="", username=username)
            elif tabla == False:
                return render_template("products_admin.html", error_add_pName="", username=username)
            ...
            if 'add_uName' in a.keys(): #Formulario Agregar
                ...
                if errors == False: #Valida si hubieron errores de  sintaxis del lado del servidor
                    ...
                    if isinstance(comparar_uEmail, bool) == True:
                        ...
                        if isinstance(tabla, bool) == False: #Tabla llena
                            return render_template("users_sadmin.html", variable_jinja=tabla, username=username)
                        elif tabla == False: #Valida si la tabla esta vacia
                            return render_template("users_sadmin.html", username=username)
                        ...
                        if isinstance(tabla, bool) == False: #Tabla llena
                            return render_template("users_sadmin.html", variable_jinja=tabla, error_add_uEmail="Este correo ya se encuentra registrado.", username=username)
                        elif tabla == False: #Valida si la tabla esta vacia
                            return render_template("users_sadmin.html", username=username)           
                ...
                if correo == search_uEmail:
                        ...
                        if isinstance(tabla, bool) == False: #No habian registros                   
                            return render_template("users_sadmin.html", error_search_uEmail="No puedes editarte a ti mismo desde esta pagina, dirigete a tu Perfil para realizar la respectiva edicion", variable_jinja=tabla, username=username)
                        elif tabla == False: #Habian registros
                            return render_template("users_sadmin.html", error_search_uEmail="No puedes editarte a ti mismo desde esta pagina, dirigete a tu Perfil para realizar la respectiva edicion", username=username)
                    ...
                    if resultado == False: #No encontro el Email
                        ...
                        if isinstance(tabla, bool) == False: #No habian registros                   
                            return render_template("users_sadmin.html", error_search_uEmail="No se encontro el Email", variable_jinja=tabla, username=username)
                        elif tabla == False: #Habian registros
                            return render_template("users_sadmin.html", error_search_uEmail="No hay usuarios para buscar", username=username)                            
                        ...
                        return render_template("users_sadmin.html", upgrade_uEmail=resultado[0][0], upgrade_uName=resultado[0][1], upgrade_uLastname=resultado[0][2], upgrade_uPhone=resultado[0][3], variable_jinja=tabla, username=username)
                ...
                if session.get("user") == upgrade_uEmail: #Evalua que el superadministrador no se edite a si mismo desde gestion de usuarios
                    ...
                    return render_template("users_sadmin.html", variable_jinja=tabla, error_search_uEmail="No puedes editarte a ti mismo desde esta pagina, dirigete a tu Perfil para poder editarlo", username=username)
                    ...
                    return render_template("users_sadmin.html", variable_jinja=tabla, Confirmation="Usuario actualizado.", username=username)
                ...
                if correo == delete_uEmail:
                    ...
                    if isinstance(tabla, bool) == False: 
                        return render_template("users_sadmin.html", variable_jinja=tabla, error_delete_uEmail="No puedes Eliminar tu usuario desde esta pagina, dirigete hacia tu Perfil para realizar el respectivo proceso.", username=username)
                    elif tabla == False: 
                        return render_template("users_sadmin.html", error_delete_uEmail="No puedes Eliminar tu usuario desde esta pagina, dirigete hacia tu Perfil para realizar el respectivo proceso.", username=username)
                    ...
                    if resultado == True: #Encontro el registro y lo elimino
                        ...
                        if isinstance(tabla, bool) == False: 
                            return render_template("users_sadmin.html", variable_jinja=tabla, confirmation_delete="Usuario eliminado.", username=username)
                        elif tabla == False: 
                            return render_template("users_sadmin.html", confirmation_delete="Usuario eliminado.", username=username)
                        ...
                        if isinstance(tabla, bool) == False: #Habian datos en la tabla
                            return render_template("users_sadmin.html", variable_jinja=tabla, error_delete_uEmail="Usuario no existente.", username=username)
                        elif tabla == False: #No habian datos en la tabla
                            return render_template("users_sadmin.html", error_delete_uEmail="No hay usuarios para Eliminar.", username=username)
    ...
    if 'user' in session and session['rol'] == "Usuario":
        ...
        if request.method == 'POST':
            ...
            if 'search_bar' in a.keys():
                ...
                if len(resultados) == 0 or resultados == None:
                    busqueda_mensaje = "No se encontro el plato."
                    plato_informacion = []                   
                    return render_template("search_user.html", productos_jinja=plato_informacion, heading=busqueda_mensaje, username=username)
                else:
                    plato_informacion = db.consultarProductosNombre(resultados[0])
                    # Estos son los resultados cercanos a la búsqueda realizada
                    #Renderizar search del respectivo usuario
                    #Cargar Jinja
                    return render_template("search_user.html", productos_jinja=plato_informacion, heading="Estos son los resultados cercanos a la búsqueda realizada", username=username)

            return "<h1>Contenido intexistente</h1>"
        ...
        if request.method == 'GET':
            ...
            if isinstance(productos, bool) == True:
                ...
                return render_template("home_user.html", productos_jinja=productos, Mensaje_respuesta="No hay productos registrados.", username=username)

            elif isinstance(productos, bool) == False:

                return render_template("home_user.html", productos_jinja=productos, Mensaje_respuesta="Estos son nuestros productos.", username=username)
        ...
        if request.method == 'GET':
            ...
            if isinstance(productos, bool) == True:
                print("No detecto productos en la base de datos")
                return render_template("home_sadmin.html", productos_jinja=productos, Mensaje_respuesta="No hay productos registrados.", username=username)

            elif isinstance(productos, bool) == False:

                return render_template("home_sadmin.html", productos_jinja=productos, Mensaje_respuesta="Estos son nuestros productos.", username=username)   
        ...
        if request.method == 'GET':
            ...
            if isinstance(productos, bool) == True:
                print("No detecto productos en la base de datos")
                return render_template("home_admin.html", productos_jinja=productos, Mensaje_respuesta="No hay productos registrados.", username=username)

            elif isinstance(productos, bool) == False:

                return render_template("home_admin.html", productos_jinja=productos, Mensaje_respuesta="Estos son nuestros productos.", username=username)  
            ...
            if 'search_bar' in a.keys():
                        ...
                        if consulta == False:
                            if isinstance(resultados, bool) == False: #Existe el producto
                                ...
                                if isinstance(tabla, bool) == False: #Encontro comentarios
                                    ...
                                    return render_template("product_user.html", plato_pName=resultados[0][1], plato_pPrice=resultados[0][2], plato_pDescription=resultados[0][4], plato_pID= resultados[0][0], cantidad=cantidad, calificaciones=calificaciones, username=username, calificaciones_promedio=resultados_extra2, wish=False, wish_pID=resultados[0][0], Confirmation="Producto agregado al carrito")
                        ...
                        if consulta == False:
                            if isinstance(resultados, bool) == False: #Existe el producto
                                ...
                                if isinstance(tabla, bool) == False: #Encontro comentarios
                                    ...
                                    username = nombreAPI.username(usuario[0][1], usuario[0][2]) 
                                    print("No encontro comentarios relacionados al producto")
                                    return render_template("product_user.html", plato_pName=resultados[0][1], plato_pPrice=resultados[0][2], plato_pDescription=resultados[0][4], plato_pID= resultados[0][0], cantidad=cantidad, calificaciones=calificaciones, username=username, calificaciones_promedio=resultados_extra2, wish=False, wish_pID=resultados[0][0])
                ...
                if consulta == False:
                    ...
                    if existencia == False:
                        ...
                        if resultado == True:
                            ...
                            print(resultados)
                            if isinstance(tabla, bool) == True: #Imprimir sin tabla
                                return render_template("product_user.html", plato_pName=resultados[0][1], plato_pPrice=resultados[0][2], plato_pDescription=resultados[0][4], plato_pID= resultados[0][0], cantidad=cantidad, error_add_cComment="Algo ha fallado al momento de calificar, Intente mas tarde.", calificaciones=calificaciones, username=username, calificaciones_promedio=resultados_extra2, wish=False, wish_pID=resultados[0][0])

                            elif isinstance(tabla, bool) == False: #Imprimir con tabla
                                                    
                                return render_template("product_user.html", plato_pName=resultados[0][1], plato_pPrice=resultados[0][2], plato_pDescription=resultados[0][4], plato_pID= resultados[0][0], cantidad=cantidad, comments_jinja=tabla, error_add_cComment="Algo ha fallado al momento de calificar, Intente mas tarde.", calificaciones=calificaciones, username=username, calificaciones_promedio=resultados_extra2, wish=False, wish_pID=resultados[0][0])
                        ...
                        usuario = dbUsuarios.consultarUsuarios(correo)               
                        username = nombreAPI.username(usuario[0][1], usuario[0][2])    
                        return render_template("product_user.html", plato_pName=resultados[0][1], plato_pPrice=resultados[0][2], plato_pDescription=resultados[0][4], plato_pID= resultados[0][0], cantidad=cantidad, comments_jinja=tabla, calificaciones=calificaciones, username=username, error_add_rRate="Ya has calificado este plato.", calificaciones_promedio= resultados_extra2, wish=False, wish_pID=resultados[0][0])
                    ...
                    if existencia == False:
                        ...
                        if resultado == True:
                            ...
                            if isinstance(tabla, bool) == True: #Imprimir sin tabla
                                ...
                                return render_template("product_user.html", plato_pName=resultados[0][1], plato_pPrice=resultados[0][2], plato_pDescription=resultados[0][4], plato_pID= resultados[0][0], cantidad=cantidad, calificaciones=calificaciones, username=username, calificaciones_promedio= resultados_extra2, wish=True, wish_pID=resultados[0][0])
                        ...
                        if isinstance(tabla, bool) == True:
                            ...
                            return render_template("product_user.html", plato_pName=resultados[0][1], plato_pPrice=resultados[0][2], plato_pDescription=resultados[0][4], plato_pID= resultados[0][0], cantidad=cantidad, calificaciones=calificaciones, username=username, error_add_rRate="Ya has calificado este plato.", calificaciones_promedio= resultados_extra2, wish=True, wish_pID=resultados[0][0])

                        elif isinstance(tabla, bool) == False:
                         
                            return render_template("product_user.html", plato_pName=resultados[0][1], plato_pPrice=resultados[0][2], plato_pDescription=resultados[0][4], plato_pID= resultados[0][0], cantidad=cantidad, comments_jinja=tabla, calificaciones=calificaciones, username=username, error_add_rRate="Ya has calificado este plato.", calificaciones_promedio= resultados_extra2, wish=True, wish_pID=resultados[0][0])
                ...
                if consulta == False:
                    ...
                    if isinstance(respuesta, bool)== False:
                        ...
                        username = nombreAPI.username(usuario[0][1], usuario[0][2]) 
                        print(resultados)               
                        return render_template("product_user.html", plato_pName=resultados[0][1], plato_pPrice=resultados[0][2], plato_pDescription=resultados[0][4], plato_pID= resultados[0][0], cantidad=cantidad, comments_jinja=tabla, error_add_cComment="Este comentario ya existe (Esto es una medida de seguridad contra el reenvio de formularios)", username=username, calificaciones_promedio=resultados_extra2, wish=False, wish_pID=resultados[0][0])
                ...
                if consulta == False: #Si no existe en la lista de deseos lo añade
                    ...
                    if isinstance(resultados, bool) == False: #Existe el producto
                        ...
                        if isinstance(tabla, bool) == False: #Encontro comentarios
                            ...
                            username = nombreAPI.username(usuario[0][1], usuario[0][2])
                            print("No encontro comentarios relacionados al producto")
                            return render_template("product_user.html", plato_pName=resultados[0][1], plato_pPrice=resultados[0][2], plato_pDescription=resultados[0][4], plato_pID= resultados[0][0], cantidad=cantidad, calificaciones=calificaciones, username=username, calificaciones_promedio=resultados_extra2, wish_pID=resultados[0][0], wish=True)
                        ...
                        username = nombreAPI.username(usuario[0][1], usuario[0][2])                    
                        print("El producto no existe")
                        return render_template("product_user.html", plato_pName=resultados[0][1], plato_pPrice=resultados[0][2], plato_pDescription=resultados[0][4], plato_pID= resultados[0][0], cantidad=cantidad, calificaciones=calificaciones, username=username, calificaciones_promedio=resultados_extra2, wish_pID=resultados[0][0])
            ...
            if 'search_bar' in a.keys():
                ...
                if isinstance(resultados, bool) == False: #Existe el producto
                    ...
                    if isinstance(tabla, bool) == False: #Encontro comentarios
                        ...
                        username = nombreAPI.username(usuario[0][1], usuario[0][2])
                        print("Encontro comentarios relacionados al producto")
                        return render_template("product_sadmin.html", plato_pName=resultados[0][1], plato_pPrice=resultados[0][2], plato_pDescription=resultados[0][4], plato_pID= resultados[0][0], cantidad=resultados[0][3], comments_jinja=tabla, calificaciones=calificaciones, username=username, calificaciones_promedio=resultados_extra2)
                    elif isinstance(tabla, bool) == True: #No encontro comentarios
                        correo = session.get('user')
                        resultados_extra = dbUsuarios.consultarUsuarios(correo)
                        resultados_extra2 = dbCalificaciones.promedioCalificaciones(ID)        
                        ...
                        username = nombreAPI.username(usuario[0][1], usuario[0][2])
                        print("No encontro comentarios relacionados al producto")
                        return render_template("product_sadmin.html", plato_pName=resultados[0][1], plato_pPrice=resultados[0][2], plato_pDescription=resultados[0][4], plato_pID= resultados[0][0], cantidad=resultados[0][3], calificaciones=calificaciones, username=username, calificaciones_promedio=resultados_extra2)
...
def profile():
    ...
    if 'user' in session and session['rol'] == "Usuario":
        ...
        if request.method == 'POST':
            ...
            if 'search_bar' in a.keys():
                ...
                if isinstance(resultados, bool)==False:
                    return render_template("profile_user.html", upgrade_uEmail=resultados[0][0], upgrade_uName=resultados[0][1], upgrade_uLastname=resultados[0][2], upgrade_uPhone=resultados[0][3], confirmation_upgrade=confirmacion, username=username)
                ...
                if respuesta == True: #la contraseña coincide con la de la base de datos
                    ...
                    if resultado == True: #Se ha actualizado la contraseña
                        ...
                        if isinstance(resultados, bool)==False:
                            return render_template("profile_user.html", upgrade_uEmail=resultados[0][0], upgrade_uName=resultados[0][1], upgrade_uLastname=resultados[0][2], upgrade_uPhone=resultados[0][3], confirmation_password=confirmacion, username=username)
                        elif isinstance(resultados, bool)==True:
                    ...
                    if isinstance(resultados, bool)==False:
                        return render_template("profile_user.html", upgrade_uEmail=resultados[0][0], upgrade_uName=resultados[0][1], upgrade_uLastname=resultados[0][2], upgrade_uPhone=resultados[0][3], error_upgrade_uPass1=confirmacion, username=username)
                    elif isinstance(resultados, bool)==True:
                        return "<h1>Usuario no encontrado al momento de cargar contenidos de la pagina</h1>"
        ...
        if request.method == 'GET':
            ...
            print("REQUEST DE PERFIL USUARIO")
            correo = session.get('user')
            print(correo)
            resultados = dbUsuarios.consultarUsuarios(correo)          
            usuario = dbUsuarios.consultarUsuarios(correo)               
            ...
            if isinstance(resultados, bool)==False:
                return render_template("profile_user.html", upgrade_uEmail=resultados[0][0], upgrade_uName=resultados[0][1], upgrade_uLastname=resultados[0][2], upgrade_uPhone=resultados[0][3], username=username)
            elif isinstance(resultados, bool)==True:
                return "<h1>Usuario no encontrado</h1>"
        ...
        if request.method == 'POST':
            ...
            if 'search_bar' in a.keys():
                ...
                if isinstance(resultados, bool)==False:
                    return render_template("profile_admin.html", upgrade_uEmail=resultados[0][0], upgrade_uName=resultados[0][1], upgrade_uLastname=resultados[0][2], upgrade_uPhone=resultados[0][3], confirmation_upgrade=confirmacion, username=username)
                elif isinstance(resultados, bool)==True:
                    return "<h1>Usuario no encontrado</h1>"
                ...
                if respuesta == True: #la contraseña coincide con la de la base de datos
                    ...
                    if resultado == True: #Se ha actualizado la contraseña
                        ...
                        if isinstance(resultados, bool)==False:
                            return render_template("profile_admin.html", upgrade_uEmail=resultados[0][0], upgrade_uName=resultados[0][1], upgrade_uLastname=resultados[0][2], upgrade_uPhone=resultados[0][3], confirmation_password=confirmacion, username=username)
                        elif isinstance(resultados, bool)==True:
                            return "<h1>Usuario no encontrado al momento de cargar contenidos de la pagina</h1>"
                    ...
                    if isinstance(resultados, bool)==False:
                        return render_template("profile_admin.html", upgrade_uEmail=resultados[0][0], upgrade_uName=resultados[0][1], upgrade_uLastname=resultados[0][2], upgrade_uPhone=resultados[0][3], error_upgrade_uPass1=confirmacion, username=username)
                    elif isinstance(resultados, bool)==True:
                        return "<h1>Usuario no encontrado al momento de cargar contenidos de la pagina</h1>"
        ...
        if request.method == 'GET':
            ...
            if isinstance(resultados, bool)==False:
                return render_template("profile_admin.html", username=username, upgrade_uEmail=resultados[0][0], upgrade_uName=resultados[0][1], upgrade_uLastname=resultados[0][2], upgrade_uPhone=resultados[0][3])
            elif isinstance(resultados, bool)==True:
                return "<h1>Usuario no encontrado</h1>"
        ...
        if request.method == 'POST':
            ...
            if 'upgrade_uName' in a.keys():
                ...
                if isinstance(resultados, bool)==False:
                    return render_template("profile_sadmin.html", upgrade_uEmail=resultados[0][0], upgrade_uName=resultados[0][1], upgrade_uLastname=resultados[0][2], upgrade_uPhone=resultados[0][3], confirmation_upgrade=confirmacion, username=username)
                elif isinstance(resultados, bool)==True:
                    return "<h1>Usuario no encontrado</h1>"
                ...
                if respuesta == True: #la contraseña coincide con la de la base de datos
                    ...
                    if resultado == True: #Se ha actualizado la contraseña
                        ...
                        if isinstance(resultados, bool)==False:
                            return render_template("profile_sadmin.html", upgrade_uEmail=resultados[0][0], upgrade_uName=resultados[0][1], upgrade_uLastname=resultados[0][2], upgrade_uPhone=resultados[0][3], confirmation_password=confirmacion, username=username)
                        elif isinstance(resultados, bool)==True:
                            return "<h1>Usuario no encontrado al momento de cargar contenidos de la pagina</h1>"
                    ...
                    if isinstance(resultados, bool)==False:
                        return render_template("profile_sadmin.html", upgrade_uEmail=resultados[0][0], upgrade_uName=resultados[0][1], upgrade_uLastname=resultados[0][2], upgrade_uPhone=resultados[0][3], error_upgrade_uPass1=confirmacion, username=username)
                    elif isinstance(resultados, bool)==True:
                        return "<h1>Usuario no encontrado al momento de cargar contenidos de la pagina</h1>"
        ...
        if request.method == 'GET':
            ...
            if isinstance(resultados, bool)==False:
                return render_template("profile_sadmin.html", upgrade_uEmail=resultados[0][0], upgrade_uName=resultados[0][1], upgrade_uLastname=resultados[0][2], upgrade_uPhone=resultados[0][3], username=username)
            elif isinstance(resultados, bool)==True:
                return "<h1>Usuario no encontrado</h1>"
...
def comments_user():
    ...
    if 'user' in session and session['rol'] == "Superadministrador":
        ...
        if request.method == 'POST':
            ...
            if 'search_bar' in a.keys():
                ...
                if resultados == True: #Se hizo la eliminacion y ahora debe recargar la pagina
                    ...
                    return render_template("comments_sadmin.html", delete_confirm="El comentario ha sido eliminado.", variable_jinja=resultados, username=username)
                    ...
                    return render_template("comments_sadmin.html", error_delete_cID="No se encontro la ID.", variable_jinja=resultados, username=username)
        ...
        if request.method == 'GET':
            ...
            if isinstance(resultados, bool) == True:
                return render_template("comments_sadmin.html", username=username)            
            elif isinstance(resultados, bool) == False:
                return render_template("comments_sadmin.html", variable_jinja=resultados, username=username)
    ...
    if 'user' in session and session['rol'] == "Usuario":
        ...
        if request.method == 'POST':
            ...
            if 'search_bar' in a.keys():
                ...
                if isinstance(resultados, bool)==False:
                    ...
                    return render_template("comments_user.html", upgrade_cID=resultados_verdadero[0][0], upgrade_pID=resultados_verdadero[0][1], upgrade_pName=resultados_extra[0][1], upgrade_cComment=resultados_verdadero[0][3], variable_jinja=resultados, username=username)
                    ...
                    usuario = dbUsuarios.consultarUsuarios(correo)               
                    username = nombreAPI.username(usuario[0][1], usuario[0][2])
                    return render_template("comments_user.html", error_search_cID="No se encontro la ID.", variable_jinja=resultados, username=username)
                ...
                if resultado == True:
                    ...
                    return render_template("comments_user.html", confirmation_upgrade="El comentario ha sido actualizado.", variable_jinja=resultados, username=username)
                ...
                if resultados == True: #Se hizo la eliminacion y ahora debe recargar la pagina
                    ...
                    if isinstance(resultados, bool) == True:
                        ...
                        return render_template("comments_user.html", delete_confirm="El comentario ha sido eliminado.", username=username)

                    elif isinstance(resultados, bool) == False:

                        return render_template("comments_user.html", delete_confirm="El comentario ha sido eliminado.", variable_jinja=resultados, username=username)
                    ...
                    return render_template("comments_user.html", error_delete_cID="No se encontro la ID.", variable_jinja=resultados, username=username)
        ...
        if request.method == 'GET':
            ...
            if isinstance(resultados, bool) == True:
                ...
                return render_template("comments_user.html", username=username)

            elif isinstance(resultados, bool) == False:

                return render_template("comments_user.html", variable_jinja=resultados, username=username)
...
def wish():
    ...
    if 'user' in session and session['rol'] == "Usuario":
        ...
        if request.method == 'POST':
            ...
            if 'search_bar' in a.keys():
            ...
            elif resultados == True: #Se encontro la ID y se elimino de Wish
                ...
                if isinstance(pID, bool)==True:
                    ...
                    return render_template("wish_user.html", username=username, Confirmation="Se ha removido el producto de tu Lista exitosamente.")
                    ...
                    return render_template("wish_user.html", username=username, variable_jinja=resultados_platos, Confirmation="Se ha removido el producto de tu Lista exitosamente.")
                ...
                if isinstance(pID, bool) == True:
                    ...
                    return render_template("wish_user.html", username=username, error_delete_pID="No se encontro la ID del producto en tu Lista de Deseos.")
                    ...
                    return render_template("wish_user.html", username=username, variable_jinja=resultados_platos, error_delete_pID="No se encontro la ID del producto en tu Lista de Deseos.")
        ...
        if request.method == 'GET':
            ...
            if isinstance(pID, bool)==True:
                ...
                return render_template("wish_user.html", username=username)
                ...
                return render_template("wish_user.html", username=username, variable_jinja=resultados_platos)
...
def car():
    ...
    if 'user' in session and session['rol'] == "Usuario":           
        ...
        if pID_car[0][0] == None or pID_car[0][0] == "": #Si no hay carrito (osea, carrito eliminado)
            ...
            return render_template("car_user.html", username=username)
            ...
            if pIDs_car[0][0] == None: #Evaluo si el carrito esta vacio
                ...
                if request.method == 'POST':
                    ...
                    if request.form.get("delete_billing"):
                        ...
                        return render_template("car_user.html", total=0, subtotal=0, delete_confirmation="No se encontraron productos en tu carrito para eliminar.", username=username)
                    ...
                    if 'sale_bID' in a.keys(): #Evita que el usuario inicie proceso de compra sin tener productos
                        ...
                        return render_template("car_user.html", total=0, subtotal=0, error_pruchase="No se encontraron productos en tu carrito para comprar.", username=username)

                    elif 'upgrade_pID' in a.keys():
                        
                        return render_template("car_user.html", total=0, subtotal=0, error_add_bAddress="Añade productos a tu carrito antes de comenzar con la compra", username=username)

                return render_template("car_user.html", total=0, subtotal=0, username=username) #Carga la pagina sin productos del carrito
                ...
                if request.method == 'POST':
                    ...
                    if request.form.get("delete_billing"):
                        ...
                        return render_template("car_user.html", subtotal=0, total=0, car_pID=pID_car[0][0], delete_confirmation="Carrito limpiado.", username=username)

                    if 'upgrade_pID' in a.keys():
                                    
                        Direccion = request.form.get("add_bAddress")

                        return render_template("car_user.html", variable_jinja=productos, subtotal=subtotal, total=total, car_pID=pID_car[0][0], sale_bID=pID_car[0][0], username=username)
                    ...
                    if 'sale_bID' in a.keys():                      
                        ...
                        if Direccion == "" or Direccion == None:
                            ...
                            return render_template("car_user.html", variable_jinja=productos, subtotal=subtotal, total=total, car_pID=pID_car[0][0], error_pruchase="Porfavor ingrese un destino de domicilio antes de realizar la compra.", username=username)
                            ...
                            return render_template("car_user.html", purchase_confirmation="Compra procesada exitosamente!", subtotal=0, total=0, car_pID=pID_car[0][0], username=username)
                ...
                if request.method == 'GET':
                    ...
                    Carrito = None
                    print("ENTRA AL GET")
                    return render_template("car_user.html", variable_jinja=productos, subtotal=subtotal, total=total, car_pID=pID_car[0][0], username=username)
...
def billing():
    ...
    if 'user' in session and session['rol'] == "Usuario":
        ...
        if request.method == 'POST':
            ...
            return render_template("billing_user.html", variable_jinja=historico, username=username)
    ...
    if 'user' in session and session['rol'] == "Superadministrador":
        ...
        if request.method == 'POST':
            ...
            print(historico)
            return render_template("billing_sadmin.html", variable_jinja=historico, username=username)
        ...
        if request.method == 'POST':
            ...
            if 'search_bar' in a.keys():
                ...
                if len(resultados) == 0 or resultados == None:
                    busqueda_mensaje = "No se encontro el plato."
                    plato_informacion = []                   
                    return render_template("search_admin.html", productos_jinja=plato_informacion, heading=busqueda_mensaje)
                else:
                    plato_informacion = db.consultarProductosNombre(resultados[0])
                    # Estos son los resultados cercanos a la búsqueda realizada
                    #Renderizar search del respectivo usuario
                    #Cargar Jinja
                    return render_template("search_admin.html", productos_jinja=plato_informacion, heading="Estos son los resultados cercanos a la búsqueda realizada")
            ...
            print(historico)
            return render_template("billing_admin.html", variable_jinja=historico, username=username)
...
#Ultima vez editado: 10/28/2021 9:00 a.m